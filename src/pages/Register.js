              ...
              <KeyboardAvoidingView behavior="position"> 
                ...
                <View style={styles.bodyContainer}>
                  ...
                  <View style={styles.container_input}>
                    ...
                    <VxTextBox placeholder='Email' secureTextEntry={true} onChangeText={(password) => this.password(password)}></VxTextBox>
                    <Text style={{color: '#9c9c9c'}}>{this.state.typedPassword}</Text>

                    <VxButton BtnText='Register' PageNavigation='Login' navigation={this.props.navigation} method={this.helloWorld}></VxButton>
